...
g_client_id='ac03525431bb45fda021c313a8c2d3c6'
g_client_secret='d181274d90dc4c42a969787ba6499df4'
...
def find_spotify_track(track, sp):
...
if __name__ == "__main__":
    ...
    token = util.prompt_for_user_token(spotify_username, scope='user-library-read playlist-modify-private',
    ...
    #client_credentials_manager = SpotifyClientCredentials(client_id=g_client_id, client_secret=g_client_secret)
    #sp = spotipy.Spotify(client_credentials_manager=client_credentials_manager)

    #token = util.prompt_for_user_token(spotify_username, 'playlist-modify-private', client_id=g_client_id, client_secret=g_client_secret)
    #sp = spotipy.Spotify(auth=token)

    #token = util.prompt_for_user_token(spotify_username, scope='user-library-read playlist-modify-private', client_id=g_client_id, client_secret=g_client_secret, redirect_uri=g_redirect_uri)
    #sp = spotipy.Spotify(auth=token)
